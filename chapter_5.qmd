...
```{r, echo=FALSE}
plot(y = wage1$wage, x = wage1$educ, col = "lightgreen", pch = 21, bg = "lightgrey",     
...
rug(wage1$wage, side=2, col="grey")
```
...
```{r, results='asis', echo=FALSE, warning=FALSE, message=FALSE}
stargazer(type = "text",GPA_OLS, GPA_WLS,  single.row = TRUE, header = FALSE, digits=5)
```
